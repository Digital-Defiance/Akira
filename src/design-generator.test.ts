  ...
  describe("Unit Tests", () => {
    ...
    describe("Section Generation", () => {
      ...
      it("should use custom iteration count when provided", () => {
        const customGenerator = new DesignGenerator(250);
        const requirements: RequirementsDocument = {
          introduction: "Test system",
          glossary: [],
          requirements: [],
        ...
        const design = customGenerator.generateDesign(requirements);

        expect(design.testingStrategy.iterations).toBe(250);
      });

      it("should default to 100 iterations when not provided", () => {
        const defaultGenerator = new DesignGenerator();
        const requirements: RequirementsDocument = {
          introduction: "Test system",
          glossary: [],
          requirements: [],
        ...
        const design = defaultGenerator.generateDesign(requirements);
